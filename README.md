...
$$\hat{m}_{t}^{\text{Nesterov}} = \frac{\beta_{1}\hat{m}_{t-1} + (1 - \beta_{1}) g_{t}}{1 - \beta_{1}^{t}}, \hat{v}_{t} = \frac{v_{t}}{1 - \beta_{2}^{t}}$$ with $v_{t} = \beta_{2} v_{t-1} + (1 - \beta_{2}) g_{t}^{2}$
...
- The first moment, $\hat{m}_{t} = \frac{m_{t}}{1 - \beta_{1}^{t}}$, is bias-correct, with $m_{t} = \beta_{1} m_{t-1} + (1 - \beta_{1}) g_{t}$.
